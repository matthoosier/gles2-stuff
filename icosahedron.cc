...
redraw(void *data, struct wl_callback *callback, uint32_t time)
{
	...
	glVertexAttribPointer(window->gl.pos, 3, GL_FLOAT, GL_FALSE, 0, icosahedron_vertices);
	glEnableVertexAttribArray(window->gl.pos);

	glVertexAttribPointer(window->gl.color, 3, GL_FLOAT, GL_FALSE, 0, icosahedron_vertex_colors);
